...
public class ApacheHttpClient implements IHttpClient {
    ...
    private static Logger LOG = LoggerFactory.getLogger(us.binance.infra.notification.apppush.jiguang.ApacheHttpClient.class);
    ...
    public ApacheHttpClient(String authCode, HttpProxy proxy, ClientConfig config) {
        ...
        _maxKeepAlive = config.containsKey(Constant.JPUSH_CONNECTION_MAX_KEEP_ALIVE) ? (Integer) config.get(Constant.JPUSH_CONNECTION_MAX_KEEP_ALIVE) : 60000;
        if (proxy != null) {
    ...
    public CloseableHttpClient createHttpClient(int maxTotal, int maxPerRoute, int maxRoute,
        ...
        _cm.setValidateAfterInactivity(1000);
        ...
        ConnectionKeepAliveStrategy keepAliveStrategy = new  DefaultConnectionKeepAliveStrategy() {
            ...
            public long getKeepAliveDuration(HttpResponse response, HttpContext context) {
                ...
                return keepAlive <= 0 ? _maxKeepAlive : keepAlive;
            }
        };
        ...
        return HttpClients.custom()
                ...
                .evictIdleConnections(_maxKeepAlive /2, TimeUnit.MILLISECONDS)
    ...
    public ResponseWrapper sendGet(String url) throws APIConnectionException, APIRequestException {
        ...
        try {
            ...
            try {
                ...
                LOG.warn("fail to close response", e);
            }
        }
        return wrapper;
...
//        return doRequest(url, content, RequestMethod.PUT);
    ...
    public void close() {
        try {
            ...
            LOG.warn("fail to close httpclient", e);
        }
    }
